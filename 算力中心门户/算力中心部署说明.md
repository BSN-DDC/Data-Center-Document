...
| [portal-web](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.1.0/deployPackageAndConfiguration/packages/front-server/portal.zip)                            | 门户前端页面 |  |
| [operation-web](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.1.0/deployPackageAndConfiguration/packages/front-server/operation.zip)                       | 运营系统前端页面 |  |
