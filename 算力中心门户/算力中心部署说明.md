...
- Mysql应用启动文件：[mysql.tar.gz](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.1.0/deployPackageAndConfiguration/config-files/dockerAndShell/Base/mysql.tar.gz)
```shell
...
- Nacos应用启动文件：[Nacos.tar.gz](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.1.0/deployPackageAndConfiguration/config-files/dockerAndShell/Base/nacos.tar.gz)
...
- 应用服务端配置文件压缩包下载：[app.yaml](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/index.html#v2.1.0/deployPackageAndConfiguration/config-files/nacos-app/)
...
- redis应用启动文件：[redis.tar.gz](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.1.0/deployPackageAndConfiguration/config-files/dockerAndShell/Base/redis.tar.gz)
```shell
...
#### 4.6.1. Sftp安装包目录结构
- sftp应用启动文件：[sftp.tar.gz](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.1.0/deployPackageAndConfiguration/config-files/dockerAndShell/Base/sftp.tar.gz)
```shell
# 按照如下目录结构创建文件夹
sftp
├── data
...
- 后端相关微服务单个服务独立启动文件：[ddcsrv.tar.gz](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.1.0/deployPackageAndConfiguration/config-files/dockerAndShell/DDC-Srv.tar.gz)
...
Please enter the nacos server ip: <nacos服务器IP地址>
Please enter the nacos server port: <nacos服务器web端口>
```
...
# 启动微服务
cd /bsn/DDC-Srv/ddc-<service_name>
docker-compose up -d
```
**一键启动**（用于微服务部署在一台服务器）
- 后端微服务一键启动文件： [一键启动文件地址](https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.1.0/deployPackageAndConfiguration/config-files/dockerAndShell/DDC-Srv-QuickStart.tar.gz)
