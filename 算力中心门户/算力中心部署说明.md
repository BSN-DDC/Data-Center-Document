...
| 2024-1-23             | v1.3                    | 张云龙                  | 新增安顺链部署文档，变更 mysql 版本号                    |
...
| anshun-node   | 2 核 | 4GB    | 40GB     | 200GB    | 安顺链外部节点                        |
...
| anshun-node   | 4 核 | 16GB   | 40GB     | 200GB    | 安顺链外部节点                    |
...
| 分类     | 软件                  | 版本      | 备注                                                   |
| -------- | --------------------- | --------- | ------------------------------------------------------ |
| 操作系统 | CentOS                | 7.6+      | 不推荐使用                                             |
| 操作系统 | Ubuntu                | 22.04     | 推荐使用                                               |
...
| 数据库             | mysql:8.0.3                                   | 8.0.3      | 算力中心 v2.3.4 之后的版本仅支持 8.0+ 的版本 |
...
| docker 镜像-链节点 | bsnddc/anshunchain:v1.7.0                    |            |                                              |
...
| redis    | 6379   | 缓存服务          | 对服务器内部开放 |
| sftp     | 8012   | 文件服务          | 对服务器内部开放 |
...
| ddc-opsjob            | 8061   | 运营后端计划任务服务  | 对服务器内部开放 |
| ddc-account           | 8072   | 账户服务              | 对服务器内部开放 |
| ddc-base              | 8071   | 算力中心基础服务      | 对服务器内部开放 |
| ddc-ops               | 8081   | 运营后端服务          | 对服务器内部开放 |
| ddc-auth              | 8091   | 算力中心权限服务      | 对服务器内部开放 |
| ddc-oai               | 18080  | 算力中心 OpenAPI 服务 | 对服务器内部开放 |
| ddc-swap-api          | 9070   | 交易服务              | 对服务器内部开放 |
| ddc-swap-job          | 38021  | 交易 job 服务         | 对服务器内部开放 |
| ddc-chainsrv-wenchang | 32010  | 文昌链服务            | 对服务器内部开放 |
| ddc-chainsrv-taian    | 32020  | 泰安链服务            | 对服务器内部开放 |
| ddc-chainsrv-zhongyi  | 32030  | 中移链服务            | 对服务器内部开放 |
| ddc-chainsrv-wuhan    | 32040  | 武汉链服务            | 对服务器内部开放 |
| ddc-chainsrv-anshun   | 32050  | 安顺链服务            | 对服务器内部开放 |
...
| 18602  | kong 节点网关代理 https/websockets 端口 | 对外开放     |
| 18603  | kong 节点网关代理 grpcs 端口            | 对外开放     |
| 18605  | kong 节点网关代理 grpc 端口             | 对外开放     |
| 8440   | 运营页面访问端口                        | 对外开放     |
| 8441   | 门户页面访问端口                        | 对外开放     |
| 8442   | OpenAPI 服务代理端口                    | 对外开放     |
...
| 18602  | https/websockets 端口 | 对 openresty-ngx 开放 |
| 18603  | grpcs 端口            | 对 openresty-ngx 开放 |
| 18605  | grpc 端口             | 对 openresty-ngx 开放 |
...
| redis                  | calc.datacenter.redis      | CALC-DB-ip 地址       | 根据实际内网 IP 地址填写 |
| nacos                  | calc.datacenter.nacos      | CALC-DB-ip 地址       | 根据实际内网 IP 地址填写 |
| sftp                   | calc.datacenter.sftp       | sftp-ip 地址          | 根据实际内网 IP 地址填写 |
| ddc-oai（OpenAPI）     | calc.datacenter.openapi    | openapi-IP 地址       | 根据实际内网 IP 地址填写 |
| kong 节点网关          | calc.datacenter.opbgateway | kong 节点网关 ip 地址 | 根据实际内网 IP 地址填写 |
| ddc-ops（运营后端）    | calc.datacenter.operation  | 运营后端 IP           | 根据实际内网 IP 地址填写 |
| ddc-portal（门户后端） | calc.datacenter.portal     | portal                | 根据实际内网 IP 地址填写 |
...
calc-opbgateway服务器ip地址  calc.datacenter.opbgateway
calc-frond-end服务器ip地址   calc.datacenter.openapi
calc-back-end服务器ip地址    calc.datacenter.operation calc.datacenter.portal
```
...
<strong>Ubuntu 22.04</strong>需要安装 policycoreutils-python-utils
...
| wuhan-node.tar.gz          | 武汉链外部节点启动文件                                                                       |                                                             |
| anshu-node.tar.gz          | 安顺链外部节点启动文件                                                                       |                                                             |
| ddc-kong-gateway-main      | kong 节点网关                                                                                |                                                             |
...
```
# 下载链接
https://data-center.s3.cn-northwest-1.amazonaws.com.cn/startup-files/nacos-app/nacos_config_export.zip
```
...
![](static/S8s1bC8vNo1WtOxxf77cZQ58nNf.jpg)

### 标准版

![](static/RuO0b2aHyoNX57xgbqBcQM7OnHg.jpg)

### 完整版

![](static/B3iebzOxCo7YD9xrupocD5Vxnec.jpg)
...
```bash
wget -O /bsn/mysql/script/mysql-schema.sql https://data-center.s3.cn-northwest-1.amazonaws.com.cn/<strong><最新版本号></strong>/deployPackageAndConfiguration/database/mysql/mysql-schema.sql
```
...
2024-01-23 09:21:41+08:00 [Note] [Entrypoint]: Entrypoint script for MySQL Server 8.0.34-1.el8 started.
2024-01-23 09:21:41+08:00 [Note] [Entrypoint]: Switching to dedicated user 'mysql'
2024-01-23 09:21:41+08:00 [Note] [Entrypoint]: Entrypoint script for MySQL Server 8.0.34-1.el8 started.
'/var/lib/mysql/mysql.sock' -> '/var/run/mysqld/mysqld.sock'
2024-01-23T01:21:42.071347Z 0 [Warning] [MY-010139] [Server] Changed limits: max_open_files: 65536 (requested 500000)
2024-01-23T01:21:42.071362Z 0 [Warning] [MY-010141] [Server] Changed limits: max_connections: 64726 (requested 100000)
2024-01-23T01:21:42.071371Z 0 [Warning] [MY-010142] [Server] Changed limits: table_open_cache: 400 (requested 4000)
2024-01-23T01:21:42.456282Z 0 [Warning] [MY-011068] [Server] The syntax '--skip-host-cache' is deprecated and will be removed in a future release. Please use SET GLOBAL host_cache_size=0 instead.
2024-01-23T01:21:42.456318Z 0 [Warning] [MY-011068] [Server] The syntax '--skip-host-cache' is deprecated and will be removed in a future release. Please use SET GLOBAL host_cache_size=0 instead.
2024-01-23T01:21:42.456341Z 0 [Warning] [MY-011070] [Server] 'Disabling symbolic links using --skip-symbolic-links (or equivalent) is the default. Consider not using this option as it' is deprecated and will be removed in a future release.
2024-01-23T01:21:42.460659Z 0 [Warning] [MY-010918] [Server] 'default_authentication_plugin' is deprecated and will be removed in a future release. Please use authentication_policy instead.
2024-01-23T01:21:42.460694Z 0 [System] [MY-010116] [Server] /usr/sbin/mysqld (mysqld 8.0.34) starting as process 1
2024-01-23T01:21:42.472561Z 1 [System] [MY-013576] [InnoDB] InnoDB initialization has started.
2024-01-23T01:21:42.778986Z 1 [System] [MY-013577] [InnoDB] InnoDB initialization has ended.
2024-01-23T01:21:43.159021Z 0 [Warning] [MY-010068] [Server] CA certificate ca.pem is self signed.
2024-01-23T01:21:43.159146Z 0 [System] [MY-013602] [Server] Channel mysql_main configured to support TLS. Encrypted connections are now supported for this channel.
2024-01-23T01:21:43.163628Z 0 [Warning] [MY-011810] [Server] Insecure configuration for --pid-file: Location '/var/run/mysqld' in the path is accessible to all OS users. Consider choosing a different directory.
2024-01-23T01:21:43.195439Z 0 [System] [MY-011323] [Server] X Plugin ready for connections. Bind-address: '::' port: 33060, socket: /var/run/mysqld/mysqlx.sock
2024-01-23T01:21:43.195470Z 0 [System] [MY-010931] [Server] /usr/sbin/mysqld: ready for connections. Version: '8.0.34'  socket: '/var/run/mysqld/mysqld.sock'  port: 3306  MySQL Community Server - GPL.
 (GPL)
```
...
```bash
update ddc_hashrate.sys_user_principal set user_email='<用户提供的邮箱地址>' where user_id='1';
```
...
![](static/H3TBbfyH3oYGrbx0jPFcO4fjnlg.png)
...
| ddc-chainsrv-zhongyi.yaml   | 中移链服务配置            | BSN-DDC 账户注册平台获取          | 是                            | address: "16 进制链账户地址"privateKey: "16 进制私钥"                                |
| ddc-chainsrv-taian.yaml     | 泰安链服务配置            | BSN-DDC 账户注册平台获取          | 是                            | address: "16 进制 链账户地址"privateKey: "16 进制私钥"                               |
| ddc-chainsrv-wuhan.yaml     | 武汉链服务配置            | BSN-DDC 账户注册平台获取          | 是                            | address: "16 进制 链账户地址"privateKey: "16 进制私钥"                               |
| ddc-chainsrv-anshun.yaml    | 安顺链服务配置            | 填写 kong 网关地址                | 是                            | url: http://kong-url:18601/api/<api-key>/neoevm/rpcapi-key 是 nacos 的 kong 网关配置 |
...
```bash
sudo wget -P /bsn/ddc-oai/pkg https://data-center.s3.cn-northwest-1.amazonaws.com.cn/v2.2.5/deployPackageAndConfiguration/packages/back-server/ddc-oai.jar
```
...
2023-02-21 18:02:59.428  [main] INFO  com.reddate.ddc.WuhanChainServiceApplication - The following 1 profile is active: "chainsrv"
2023-02-21 18:03:01.817  [main] INFO  o.springframework.cloud.context.scope.GenericScope - BeanFactory id=3ac7bcae-8368-3f52-b83b-253fbf456a9a
2023-02-21 18:03:02.793  [main] INFO  o.s.boot.web.embedded.tomcat.TomcatWebServer - Tomcat initialized with port(s): 32020 (http)
2023-02-21 18:03:02.813  [main] INFO  org.apache.coyote.http11.Http11NioProtocol - Initializing ProtocolHandler ["http-nio-32020"]
2023-02-21 18:03:02.814  [main] INFO  org.apache.catalina.core.StandardService - Starting service [Tomcat]
...
```bash
wget -P /bsn/chainsrv/ddc-chainsrv-anshun/pkg/ https://data-center.s3.cn-northwest-1.amazonaws.com.cn/<最新版本号>/deployPackageAndConfiguration/packages/chain-server/ddc-chainsrv-anshun.jar
```

进入安顺链服务工作目录

```bash
cd /bsn/chainsrv/ddc-chainsrv-anshun
```
...
```bash
sudo docker logs -f --tail 30 ddc-chainsrv-anshun
```

输出结果

```bash
[root@AWS-NGX01-A159 ddc-chainsrv-anshun]# docker logs -f ddc-chainsrv-anshun
2023-12-25 13:40:39.684  [background-preinit] INFO  org.hibernate.validator.internal.util.Version - HV000001: Hibernate Validator 6.2.4.Final
2023-12-25 13:40:41.296  [main] INFO  c.a.n.p.auth.spi.client.ClientAuthPluginManager - [ClientAuthPluginManager] Load ClientAuthService com.alibaba.nacos.client.auth.impl.NacosClientAuthServiceImpl success.
2023-12-25 13:40:41.298  [main] INFO  c.a.n.p.auth.spi.client.ClientAuthPluginManager - [ClientAuthPluginManager] Load ClientAuthService com.alibaba.nacos.client.auth.ram.RamClientAuthServiceImpl success.
...
2023-12-25 13:40:44.608  [main] WARN  c.a.cloud.nacos.client.NacosPropertySourceBuilder - Ignore the empty nacos configuration and get it based on dataId[ddc-chainsrv-anshun] & group[DEFAULT_GROUP]
2023-12-25 13:40:44.615  [main] WARN  c.a.cloud.nacos.client.NacosPropertySourceBuilder - Ignore the empty nacos configuration and get it based on dataId[ddc-chainsrv-anshun.properties] & group[DEFAULT_GROUP]
2023-12-25 13:40:44.623  [main] WARN  c.a.cloud.nacos.client.NacosPropertySourceBuilder - Ignore the empty nacos configuration and get it based on dataId[ddc-chainsrv-anshun-chainsrv.properties] & group[DEFAULT_GROUP]
2023-12-25 13:40:44.624  [main] INFO  o.s.c.b.c.PropertySourceBootstrapConfiguration - Located property source: [BootstrapPropertySource {name='bootstrapProperties-ddc-chainsrv-anshun-chainsrv.properties,DEFAULT_GROUP'}, BootstrapPropertySource {name='bootstrapProperties-ddc-chainsrv-anshun.properties,DEFAULT_GROUP'}, BootstrapPropertySource {name='bootstrapProperties-ddc-chainsrv-anshun,DEFAULT_GROUP'}, BootstrapPropertySource {name='bootstrapProperties-kong-gateway-config.yml,COMMON_GROUP'}, BootstrapPropertySource {name='bootstrapProperties-ddc_server_port_default.yml,COMMON_GROUP'}, BootstrapPropertySource {name='bootstrapProperties-system-config.yaml,COMMON_GROUP'}, BootstrapPropertySource {name='bootstrapProperties-ddc-chainsrv-anshun.yaml,CHAINSRV_GROUP'}]
2023-12-25 13:40:44.701  [main] INFO  com.reddate.ddc.AnshunChainServiceApplication - The following 1 profile is active: "chainsrv"
2023-12-25 13:40:47.332  [main] INFO  o.springframework.cloud.context.scope.GenericScope - BeanFactory id=3f3dc336-bfb0-3749-82b0-e4ec3f21bbdd
2023-12-25 13:40:48.423  [main] INFO  o.s.boot.web.embedded.tomcat.TomcatWebServer - Tomcat initialized with port(s): 32050 (http)
2023-12-25 13:40:48.453  [main] INFO  org.apache.coyote.http11.Http11NioProtocol - Initializing ProtocolHandler ["http-nio-32050"]
2023-12-25 13:40:48.456  [main] INFO  org.apache.catalina.core.StandardService - Starting service [Tomcat]
2023-12-25 13:40:48.456  [main] INFO  org.apache.catalina.core.StandardEngine - Starting Servlet engine: [Apache Tomcat/9.0.65]
2023-12-25 13:40:48.791  [main] INFO  o.a.c.core.ContainerBase.[Tomcat].[localhost].[/] - Initializing Spring embedded WebApplicationContext
2023-12-25 13:40:48.792  [main] INFO  o.s.b.w.s.c.ServletWebServerApplicationContext - Root WebApplicationContext: initialization completed in 4042 ms
2023-12-25 13:40:50.136  [main] INFO  o.s.b.actuate.endpoint.web.EndpointLinksResolver - Exposing 1 endpoint(s) beneath base path '/ddc'
2023-12-25 13:40:51.565  [main] WARN  com.netflix.config.sources.URLConfigurationSource - No URLs will be polled as dynamic configuration sources.
2023-12-25 13:40:51.565  [main] INFO  com.netflix.config.sources.URLConfigurationSource - To enable URLs as dynamic configuration sources, define System property archaius.configurationSource.additionalUrls or make config.properties available on classpath.
2023-12-25 13:40:51.580  [main] WARN  com.netflix.config.sources.URLConfigurationSource - No URLs will be polled as dynamic configuration sources.
2023-12-25 13:40:51.580  [main] INFO  com.netflix.config.sources.URLConfigurationSource - To enable URLs as dynamic configuration sources, define System property archaius.configurationSource.additionalUrls or make config.properties available on classpath.
2023-12-25 13:40:52.455  [main] WARN  o.s.c.l.c.LoadBalancerCacheAutoConfiguration$LoadBalancerCaffeineWarnLogger - Spring Cloud LoadBalancer is currently working with the default cache. While this cache implementation is useful for development and tests, it's recommended to use Caffeine cache in production.You can switch to using Caffeine cache, by adding it and org.springframework.cache.caffeine.CaffeineCacheManager to the classpath.
2023-12-25 13:40:52.645  [main] INFO  com.alibaba.nacos.client.naming - initializer namespace from System Property : null
2023-12-25 13:40:52.646  [main] INFO  com.alibaba.nacos.client.naming - initializer namespace from System Environment :null
2023-12-25 13:40:52.646  [main] INFO  com.alibaba.nacos.client.naming - initializer namespace from System Property :null
2023-12-25 13:40:52.671  [main] INFO  c.a.n.p.auth.spi.client.ClientAuthPluginManager - [ClientAuthPluginManager] Load ClientAuthService com.alibaba.nacos.client.auth.impl.NacosClientAuthServiceImpl success.
2023-12-25 13:40:52.671  [main] INFO  c.a.n.p.auth.spi.client.ClientAuthPluginManager - [ClientAuthPluginManager] Load ClientAuthService com.alibaba.nacos.client.auth.ram.RamClientAuthServiceImpl success.
2023-12-25 13:40:52.691  [main] INFO  com.alibaba.nacos.common.remote.client - [RpcClientFactory] create a new rpc client of 1f282f33-a569-4c96-82e7-ac95a478a948
2023-12-25 13:40:52.691  [main] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] RpcClient init label, labels = {module=naming, source=sdk}
2023-12-25 13:40:52.700  [main] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] RpcClient init, ServerListFactory = com.alibaba.nacos.client.naming.core.ServerListManager
2023-12-25 13:40:52.700  [main] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Registry connection listener to current client:com.alibaba.nacos.client.naming.remote.gprc.redo.NamingGrpcRedoService
2023-12-25 13:40:52.701  [main] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Register server push request handler:com.alibaba.nacos.client.naming.remote.gprc.NamingPushRequestHandler
2023-12-25 13:40:52.708  [main] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Try to connect to server on start up, server: {serverIp = 'calc.datacenter.nacos', server main port = 8848}
2023-12-25 13:40:52.841  [main] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Success to connect to server [calc.datacenter.nacos:8848] on start up, connectionId = 1703482852717_10.0.2.29_36577
2023-12-25 13:40:52.841  [main] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Register server push request handler:com.alibaba.nacos.common.remote.client.RpcClient$ConnectResetRequestHandler
2023-12-25 13:40:52.841  [main] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Register server push request handler:com.alibaba.nacos.common.remote.client.RpcClient$$Lambda$344/1452012306
2023-12-25 13:40:52.845  [com.alibaba.nacos.client.remote.worker] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Notify connected event to listeners.
2023-12-25 13:40:52.847  [main] INFO  com.alibaba.nacos.client.naming - [SUBSCRIBE-SERVICE] service:ddc-chainsrv-anshun, group:DEFAULT_GROUP, clusters:DEFAULT 
2023-12-25 13:40:52.849  [com.alibaba.nacos.client.remote.worker] INFO  com.alibaba.nacos.client.naming - Grpc connection connect
2023-12-25 13:40:52.925  [main] INFO  com.alibaba.nacos.client.naming - init new ips(0) service: DEFAULT_GROUP@@ddc-chainsrv-anshun@@DEFAULT -> []
2023-12-25 13:40:52.964  [main] INFO  com.alibaba.nacos.client.naming - current ips:(0) service: DEFAULT_GROUP@@ddc-chainsrv-anshun@@DEFAULT -> []
2023-12-25 13:40:52.987  [main] INFO  org.apache.coyote.http11.Http11NioProtocol - Starting ProtocolHandler ["http-nio-32050"]
2023-12-25 13:40:53.046  [main] INFO  o.s.boot.web.embedded.tomcat.TomcatWebServer - Tomcat started on port(s): 32050 (http) with context path ''
2023-12-25 13:40:53.062  [main] INFO  com.alibaba.nacos.client.naming - [REGISTER-SERVICE] ddc_hashrate_system registering service ddc-chainsrv-anshun with instance Instance{instanceId='null', ip='10.0.2.29', port=32050, weight=1.0, healthy=true, enabled=true, ephemeral=true, clusterName='DEFAULT', serviceName='null', metadata={management.endpoints.web.base-path=/ddc, preserved.register.source=SPRING_CLOUD}}
2023-12-25 13:40:53.084  [main] INFO  c.a.cloud.nacos.registry.NacosServiceRegistry - nacos registry, DEFAULT_GROUP ddc-chainsrv-anshun 10.0.2.29:32050 register finished
2023-12-25 13:40:53.527  [nacos-grpc-client-executor-calc.datacenter.nacos-1] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Receive server push request, request = NotifySubscriberRequest, requestId = 12
2023-12-25 13:40:53.543  [nacos-grpc-client-executor-calc.datacenter.nacos-1] INFO  com.alibaba.nacos.client.naming - new ips(1) service: DEFAULT_GROUP@@ddc-chainsrv-anshun@@DEFAULT -> [{"ip":"10.0.2.29","port":32050,"weight":1.0,"healthy":true,"enabled":true,"ephemeral":true,"clusterName":"DEFAULT","serviceName":"DEFAULT_GROUP@@ddc-chainsrv-anshun","metadata":{"management.endpoints.web.base-path":"/ddc","preserved.register.source":"SPRING_CLOUD"},"ipDeleteTimeout":30000,"instanceHeartBeatInterval":5000,"instanceHeartBeatTimeOut":15000}]
2023-12-25 13:40:53.544  [nacos-grpc-client-executor-calc.datacenter.nacos-1] INFO  com.alibaba.nacos.client.naming - current ips:(1) service: DEFAULT_GROUP@@ddc-chainsrv-anshun@@DEFAULT -> [{"ip":"10.0.2.29","port":32050,"weight":1.0,"healthy":true,"enabled":true,"ephemeral":true,"clusterName":"DEFAULT","serviceName":"DEFAULT_GROUP@@ddc-chainsrv-anshun","metadata":{"management.endpoints.web.base-path":"/ddc","preserved.register.source":"SPRING_CLOUD"},"ipDeleteTimeout":30000,"instanceHeartBeatInterval":5000,"instanceHeartBeatTimeOut":15000}]
2023-12-25 13:40:53.544  [nacos-grpc-client-executor-calc.datacenter.nacos-1] INFO  com.alibaba.nacos.common.remote.client - [1f282f33-a569-4c96-82e7-ac95a478a948] Ack server push request, request = NotifySubscriberRequest, requestId = 12
2023-12-25 13:40:53.662  [main] INFO  com.reddate.ddc.AnshunChainServiceApplication - Started AnshunChainServiceApplication in 15.592 seconds (JVM running for 17.475)
2023-12-25 13:40:53.745  [main] INFO  com.alibaba.nacos.client.config.impl.CacheData - nacos.cache.data.init.snapshot = true 
2023-12-25 13:40:53.746  [main] INFO  com.alibaba.nacos.client.config.impl.ClientWorker - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [subscribe] kong-gateway-config.yml+COMMON_GROUP+ddc_hashrate_system
2023-12-25 13:40:53.748  [main] INFO  com.alibaba.nacos.client.config.impl.CacheData - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [add-listener] ok, tenant=ddc_hashrate_system, dataId=kong-gateway-config.yml, group=COMMON_GROUP, cnt=1
2023-12-25 13:40:53.750  [main] INFO  com.alibaba.nacos.client.config.impl.ClientWorker - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [subscribe] system-config.yaml+COMMON_GROUP+ddc_hashrate_system
2023-12-25 13:40:53.750  [main] INFO  com.alibaba.nacos.client.config.impl.CacheData - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [add-listener] ok, tenant=ddc_hashrate_system, dataId=system-config.yaml, group=COMMON_GROUP, cnt=1
2023-12-25 13:40:53.750  [main] INFO  com.alibaba.nacos.client.config.impl.ClientWorker - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [subscribe] ddc-chainsrv-anshun-chainsrv.properties+DEFAULT_GROUP+ddc_hashrate_system
2023-12-25 13:40:53.750  [main] INFO  com.alibaba.nacos.client.config.impl.CacheData - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [add-listener] ok, tenant=ddc_hashrate_system, dataId=ddc-chainsrv-anshun-chainsrv.properties, group=DEFAULT_GROUP, cnt=1
2023-12-25 13:40:53.768  [main] INFO  com.alibaba.nacos.client.config.impl.ClientWorker - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [subscribe] ddc-chainsrv-anshun.yaml+CHAINSRV_GROUP+ddc_hashrate_system
2023-12-25 13:40:53.768  [main] INFO  com.alibaba.nacos.client.config.impl.CacheData - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [add-listener] ok, tenant=ddc_hashrate_system, dataId=ddc-chainsrv-anshun.yaml, group=CHAINSRV_GROUP, cnt=1
2023-12-25 13:40:53.769  [main] INFO  com.alibaba.nacos.client.config.impl.ClientWorker - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [subscribe] ddc-chainsrv-anshun+DEFAULT_GROUP+ddc_hashrate_system
2023-12-25 13:40:53.769  [main] INFO  com.alibaba.nacos.client.config.impl.CacheData - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [add-listener] ok, tenant=ddc_hashrate_system, dataId=ddc-chainsrv-anshun, group=DEFAULT_GROUP, cnt=1
2023-12-25 13:40:53.769  [main] INFO  com.alibaba.nacos.client.config.impl.ClientWorker - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [subscribe] ddc-chainsrv-anshun.properties+DEFAULT_GROUP+ddc_hashrate_system
2023-12-25 13:40:53.769  [main] INFO  com.alibaba.nacos.client.config.impl.CacheData - [fixed-ddc_hashrate_system-calc.datacenter.nacos_8848] [add-listener] ok, tenant=ddc_hashrate_system, dataId=ddc-chainsrv-anshun.properties, group=DEFAULT_GROUP, cnt=1
```
...
请参考《<u>武汉链节点入网部署文档</u>》进行武汉链节点入网

请参考《<u>安顺链节点入网部署文档</u>》进行安顺链节点入网
